...
$parametros=$paramperiodo.$consultacuie.$area;
  ...
  <tr>
    ...
    <td width="60%" align="center"><table width="600" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td align="center" bgcolor="#FFFFFF"><a href="beneficiario_ceb_sinpractica.php" class="encabezadopag">Cant Prestaciones Solicitadas</a></td>
    ...
    <td width="20%" align="right"><a href="excel/cantprestaciones_excel.php?param=<?=$parametros?>&amp;cuie=<?=$cuiecompleto?>">



      <?php if (isset($_POST['consultar'])){ ?>
      <img src="imgs/excel.gif" alt="Generar Archivo de Excel" width="49" height="49" /></a><a href="excel/cantprestaciones_excel.php?param=<?=$parametros?>&amp;cuie=<?=$cuiecompleto?>">
      <?php } ?>
...
<form action="" method="post" name="form1" target="_self" id="form1">
  <table width="70%" border="1" align="center" class="texto">
    <tr>
      ...
      <input type="text" name="tarea" id="tarea" value="<?php if (isset($_POST['tarea'])){ echo $_POST['tarea']; }   ?>"/></td>
    </tr>
    <tr> 
      <td>CUIE</td>
      <td colspan="2">
...
<table width="100%" border="1" class="texto">
  <tr>
    ...
    <td width="14%">Cant Practicas</td>
    <td width="14%">Importe Solicitado</td>
  </tr>
    <?php
...
$consdescrip="select NombrePrestacion, CodDiagnostico from PRESTACIONES2022 where CodPrestacion = '$codprestacion' and CodObjeto = '$codobjeto' and CodDiagnostico = '$coddiagnostico'";
...
$num=$num+1;
  ...
  <tr>
    ...
    <td><a title="<?php echo $prestacion; ?>"><?php echo $codprestacion; ?></a></td>
    <td><a title="<?php echo $objeto; ?>"><?php echo $codobjeto; ?></a></td>
    <td><a title="<?php echo $diagnostico; ?>"><?php echo $coddiagnostico; ?></a></td>
    <td align="left"><?php echo utf8_encode($descripcion_prestacion); ?></td>
